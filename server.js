...
server.get('/', (request, response) => {
  const about = {
    ...
    description: 'Graduado em Ciência da Computação e desenvolvendo em DataFlex desde 2015. É DBA em SQL Server pelo MSL. No momento é Coordenador de desenvolvimento na <a class="links" href="https://kpers.com.br/" target="_blank">KPERS</a>.',
    links: [
